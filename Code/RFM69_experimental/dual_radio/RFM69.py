...
class RFM69_433(object):
    def __init__(self, freqBand, nodeID, networkID, isRFM69HW = False, intPin = 16, rstPin = 22, spiBus = 0, spiDevice = 0):
...
class RFM69_915(object):
    def __init__(self, freqBand, nodeID, networkID, isRFM69HW = False, intPin = 18, rstPin = 22, spiBus = 0, spiDevice = 1):
