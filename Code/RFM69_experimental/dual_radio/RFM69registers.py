...
REG_TESTPA2 = 0x7C #only present on RFM69HW/SX1231H
REG_TESTDAGC = 0x6F
...
RF69_MAX_DATA_LEN = 72 # to take advantage of the built in AES/CRC we want to limit the frame size to the internal FIFO size (66 bytes - 3 bytes overhead)
