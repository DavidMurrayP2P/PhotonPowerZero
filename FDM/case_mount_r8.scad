...
difference(){
union(){
translate([-4,0,1.8])cube([98,97,7], center=true);    
...
translate([-23.5,-6.5,19.5])cube([8,69,31], center=true);
    ...
    #translate([-33.5,-6.5,20])cube([27,50,35], center=true);
    ...
    translate([-35.5,0,1])cube([26,16.3,4.7], center=true);
    ...
    translate([-51.5,-38.7,9.4]) rotate([0,0,0])  cylinder(h=22, r1=2.1, r2=2.1, center=true,$fn=24);
    
    translate([-36,-39,0])  cube([35,1.6,6], center=true);
    ...
    translate([7,-6.5,35])cube([58,52,15], center=true);
